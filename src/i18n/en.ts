...
export const messages: Record<string, string> = {
  ...
  'ai.shell.mr_platform_hint': 'When creating a merge request (MR), default to the Bits platform (bits.ai) instead of the codebase platform. Use `botmux mr create --platform bits` to create a Bits MR.',
